# [cybersheild](https://cybersheild.vercel.app/) - starter template for modern web development !

<kbd>
<a href="https://cybersheild.vercel.app/">
  <img alt="cybersheild – A starter template for modern web development with nextjs 13 (app route), tailwindcss, typescript, trpc, clerk auth, and prisma." src="https://cybersheild.vercel.app/og-image.png">
</a>
</kbd>
...
```bash
git clone https://github.com/mudassir/cybersheild.git
```
...
See the preview — <a href="https://cybersheild.vercel.app/">cybersheild</a>
